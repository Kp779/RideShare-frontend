...
function UpdateUserForm() {
    ...
    useEffect(() => {
        ...
        axios.get(`http://localhost:4002/user/register/${id}`)
            .then(result => {
                console.log(result);
    ...
    const UpdateUser =(e) =>{
        e.preventDefault();
        axios.put(`http://localhost:4002/user/update/${id}`, {fname, email, role})
        .then(result => {
            console.log(result);
    ...
    return (
        <div>
            <h2>Edit User</h2>
            <form style={{ width: '40%', marginLeft: '20rem' }} onSubmit={UpdateUser}>
                <div class="mb-3">
